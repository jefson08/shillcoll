...
<html>
    <head>
        ...
        <script type="text/javascript" src="../scripts/adm/CourseClassHons2.js"></script>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td> 
                                                    ...
                                                    <c:if test="${param.submitted and !CCH.cmbCourseNameValid}" var="v1">
                                                        Course Not Selected
                                                    </c:if>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="cmbYearOrSemNo" id="cmbYearOrSemNo">
                                                        <option value="-1">-</option>
                                                        <option value="1" ${paramValues.cmbYearOrSemNo[0]=='1'?'selected':''}>1</option>
                                                        <option value="2" ${paramValues.cmbYearOrSemNo[0]=='2'?'selected':''}>2</option>
                                                        <option value="3" ${paramValues.cmbYearOrSemNo[0]=='3'?'selected':''}>3</option>
                                                        <option value="4" ${paramValues.cmbYearOrSemNo[0]=='4'?'selected':''}>4</option>
                                                        <option value="5" ${paramValues.cmbYearOrSemNo[0]=='5'?'selected':''}>5</option>
                                                        <option value="6" ${paramValues.cmbYearOrSemNo[0]=='6'?'selected':''}>6</option>
                                                    </select> 
                                                </td>
                                                <td>
                                                    <label>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="cmbYearOrSemNo" id="cmbYearOrSemNo">
                                                        <option value="-1">-</option>
                                                        <option value="1" ${paramValues.cmbYearOrSemNo[1]=='1'?'selected':''}>1</option>
                                                        <option value="2" ${paramValues.cmbYearOrSemNo[1]=='2'?'selected':''}>2</option>
                                                        <option value="3" ${paramValues.cmbYearOrSemNo[1]=='3'?'selected':''}>3</option>
                                                        <option value="4" ${paramValues.cmbYearOrSemNo[1]=='4'?'selected':''}>4</option>
                                                        <option value="5" ${paramValues.cmbYearOrSemNo[1]=='5'?'selected':''}>5</option>
                                                        <option value="6" ${paramValues.cmbYearOrSemNo[1]=='6'?'selected':''}>6</option>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="cmbYearOrSemNo" id="cmbYearOrSemNo">
                                                        <option value="-1">-</option>
                                                        <option value="1" ${paramValues.cmbYearOrSemNo[2]=='1'?'selected':''}>1</option>
                                                        <option value="2" ${paramValues.cmbYearOrSemNo[2]=='2'?'selected':''}>2</option>
                                                        <option value="3" ${paramValues.cmbYearOrSemNo[2]=='3'?'selected':''}>3</option>
                                                        <option value="4" ${paramValues.cmbYearOrSemNo[2]=='4'?'selected':''}>4</option>
                                                        <option value="5" ${paramValues.cmbYearOrSemNo[2]=='5'?'selected':''}>5</option>
                                                        <option value="6" ${paramValues.cmbYearOrSemNo[2]=='6'?'selected':''}>6</option>
