                                        ...
                                        <tbody>                
                                            <tr>
                                                ...
                                                <td><input type="text" name="txtBoardRoll" id="txtBoardRoll" value="${param.txtBoardRoll}" size="50" />
                                                    <c:if test="${param.submitted and !clxiiinfo.txtBoardRollValid}" var="v1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> <select name="cmbStream" id="cmbStream">
                                                    ...
                                                    <c:if test="${param.submitted and !clxiiinfo.cmbStreamValid}" var="v5">
                                    ...
                                    <table id="marks"><tbody>
                                            <tr>
                                                <td colspan="2" style="text-align: center">
                                                    <c:if test="${param.submitted and !clxiiinfo.txtSubjectValid}" var="v6">
                                            ...
                                            <tr>
                                                <td colspan="2" style="text-align: center">
                                                    <c:if test="${param.submitted and !clxiiinfo.txtMarksValid}" var="v7">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td><input type="text" name="txtTotalMarks" id="txtTotalMarks" value="${param.txtTotalMarks}" size="4" />
                                                <c:if test="${param.submitted and !clxiiinfo.txtTotalMarksValid}" var="v3">
