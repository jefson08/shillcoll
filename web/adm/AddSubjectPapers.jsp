                                ...
                                <form name="CourseClassHons" method="POST">
                                    ...
                                    <table border="0" id="papers">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label>
                                                    <input name="chkPractdummy" type="checkbox" id="chkPractdummy" chkPstat="2" ${param.submitted and (paramValues.chkPract[1])?"checked":""}/>Practical
                                                </label>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label>
                                                    <input name="chkPractdummy" type="checkbox" id="chkPractdummy" chkPstat="3" ${param.submitted and (paramValues.chkPract[2])?"checked":""}/>Practical
                                                </label>
                                                    ...
                                                    <td>
                                                        ...
                                                        <td>
                                                            <label><input name="chkCategorydummy" type="checkbox" id="chkCategorydummy" chkStat="${status.index+1}" 
                                                                      ${((param.submitted and !empty(paramValues.chkCategorydummy[status.index])) or (!param.submitted2 and (ASP.chkCategory[status.index]=='true')))?'checked':''} />
                                                            Honours</label>
