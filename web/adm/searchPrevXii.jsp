                        ...
                        <div id="right-frame">
                            ...
                            <div id="processing-area">
                                <form name="clxiiinfo" method="Post">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td> <select name="cmbBoardID" id="cmbBoardID">
                                                    ...
                                                    <c:if test="${param.submitted and !clxiiinfo.cmbBoardIDValid}" var="v1">
                                            ...
                                            <tr>
                                                ...
                                                <td> <select name="txtStream" id="txtStream">
                                                    ...
                                                    <c:if test="${param.submitted and !clxiiinfo.txtStreamValid}" var="v2">
                                    ...
                                    <table border="1" id="search_content">
                                        <tbody>
                                            <!-- DISPLAY SEARCH -->
                                        </tbody>
                                    </table>
                                        ...
                                        <tbody>
                                            <tr>                                              
                                                <td style="text-align: right">
                                                    <input type="hidden" value="Next" name="Next" id="Next" /> </td>                                             
                                            </tr>
                                        </tbody>
                                    </table>
                                </form>
