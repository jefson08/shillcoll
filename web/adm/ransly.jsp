...
<html>
    ...
    <body>
   <form name="course" method="POST" action="papersappears1.jsp">

       <h1> Data From Ransly</h1>
  
       Roll No <input type="text" name="roll1" id="roll1" value="BS-PHY22015005"  size="20" /><br>
...
<br>
Year/ Semester <input type="text" name="yos" id="yos" value="s2"  size="5" /><br>
