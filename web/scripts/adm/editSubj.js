...
$(document).ready(function () {
    ...
    $('input[name=Add]').click(function () {
        ...
        str += '<td><input type="text" name="txtSubName" id="txtSubName['+count+']" value="" size="20"/></td><td><img src="../images/remove.png" alt="Remove" imgno=' + count + ' id="DelIcon"/></td><td></td></tr>';
