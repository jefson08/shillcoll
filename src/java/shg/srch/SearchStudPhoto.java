 ...
 * @author B Mukhim
 */
@WebServlet(name = "SearchStudPhoto", urlPatterns = {"/SearchStudPhoto"})
public class SearchStudPhoto extends HttpServlet {
...
//        System.out.println("Inseide server");
        ...
        try {
            ...
            if (rs.next()) {
                ...
                navig += "</div>";
                output += navig;
                output += "<form name=\"editstudphoto\" id=\"editstudphoto\" action=\"editstudphoto.jsp\" method=\"post\">";
                output +="<div class=\"CSSTableGenerator\"><table>  <tr><td>Rollno</td><td>Name</td></tr>";
                
                do {
                    output += "<tr><td><a class=\"editStu\" rollno=\"" + rs.getString("rollno").trim() + "\" "
                            + " name=\"" + rs.getString("studentname").trim() + "\" style=\"text-decoration:underline\">"
                            + rs.getString("rollno").trim()+"</a></td><td>" + rs.getString("studentname");
