 ...
 *
 */
@WebServlet(name = "clxiireport", urlPatterns = {"/clxiireport"})
public class clxiireport extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        InputStream reportStream = getServletConfig().getServletContext().getResourceAsStream("/report/clxii-Report.jasper");
