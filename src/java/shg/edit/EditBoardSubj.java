    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (rs.next()) {
                ...
                int i=0;
                do {
                    output += "<tr id="+i+"><td>Subject *</td><td><input type=\"text\" name=\"txtSubName\" size=\"50\" value=\"" + rs.getString("subjectname") + "\"/><img src=\"../images/remove.png\" alt=\"Remove\" imgno="+i+" id=\"DelIcon\"/></td></tr>"; 
                    i++;
                } while (rs.next());
            } else {
