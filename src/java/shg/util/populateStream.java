 ...
 * @author B Mukhim
 */
public class populateStream extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            while (rs.next()) {
                ...
                strXML = strXML + "<optionText>" + rs.getString("stream").toUpperCase() + "</optionText>";
                strXML = strXML + "<optionValue>" + rs.getString("stream").toUpperCase() + "</optionValue>";
                strXML = strXML + "</entry>";
            }
            strXML = strXML + "</selectChoice>";
