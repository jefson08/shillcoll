 ...
 * @author hp
 */
@WebServlet(name = "populatePaperName", urlPatterns = {"/populatePaperName"})
public class populatePaperName extends HttpServlet {
...
//        System.out.println("hellloooooo");
        ...
        String papername = request.getParameter("q0").trim();
        String classcode = request.getParameter("q1").trim();
        ...
        try {
            ...
            sql = "SELECT papercode, papername FROM shgdb.papers WHERE  shgdb.papers.coursecode = ? AND shgdb.papers.yearorsemno = ? ";
