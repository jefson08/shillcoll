 ...
 * @author B Mukhim
 */
public class populateRollno extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String coursecode = request.getParameter("q").toString().trim();
        ...
        try {
           ...
           // st = con.createStatement();
            sql = "select rollno from studentsclass where coursecode = ? ORDER BY rollno ASC";
