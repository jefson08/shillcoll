 ...
 * @author B Mukhim
 */
public class populatecoursestream extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String stcode = request.getParameter("q").trim().toUpperCase();
        String strXML = "";
        try {
            try {
            ...
            sql = "select coursecode , coursename from course where upper(streamcode) = ? ORDER BY subjectname ASC";
